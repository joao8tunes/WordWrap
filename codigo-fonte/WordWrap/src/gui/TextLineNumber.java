 ...
 * Extracted (26/11/2014) from: http://www.javaprogrammingforums.com/java-swing-tutorials/915-how-add-line-numbers-your-jtextarea.html
 */
public class TextLineNumber extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener
{
	...
	/**
	 * Specify the horizontal alignment of the digits within the component. Common values would be: <ul> <li>TextLineNumber.LEFT <li>TextLineNumber.CENTER <li>TextLineNumber.RIGHT (default) </ul>
	 * 
	 * @param currentLineForeground
	 * the Color used to render the current line
	 */
